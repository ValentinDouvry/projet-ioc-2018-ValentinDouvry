...
public class Meteore extends ObjetSpatial{
	...
	public Meteore(float[] coordonnees, int id, float masse, String nom, String annee, String position, boolean estCreeOuModifie) {
